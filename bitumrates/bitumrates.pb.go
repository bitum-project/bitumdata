...
func (*ExchangeSubscription) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{0}
}
...
func (*ExchangeRateUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{1}
}
...
func (*ExchangeRateUpdate_DepthPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{1, 1}
}
...
func (*ExchangeRateUpdate_DepthData) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{1, 2}
}
...
func (*ExchangeRateUpdate_Candlestick) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{1, 3}
}
...
func (*ExchangeRateUpdate_Candlesticks) Descriptor() ([]byte, []int) {
	return fileDescriptor_bitumrates_9bf93ce756f00f36, []int{1, 4}
}
...
func init() {
	proto.RegisterType((*ExchangeSubscription)(nil), "bitumrates.ExchangeSubscription")
	proto.RegisterType((*ExchangeRateUpdate)(nil), "bitumrates.ExchangeRateUpdate")
	proto.RegisterMapType((map[string]float64)(nil), "bitumrates.ExchangeRateUpdate.IndicesEntry")
	proto.RegisterType((*ExchangeRateUpdate_DepthPoint)(nil), "bitumrates.ExchangeRateUpdate.DepthPoint")
	proto.RegisterType((*ExchangeRateUpdate_DepthData)(nil), "bitumrates.ExchangeRateUpdate.DepthData")
	proto.RegisterType((*ExchangeRateUpdate_Candlestick)(nil), "bitumrates.ExchangeRateUpdate.Candlestick")
	proto.RegisterType((*ExchangeRateUpdate_Candlesticks)(nil), "bitumrates.ExchangeRateUpdate.Candlesticks")
}
...
// BITUMRatesClient is the client API for BITUMRates service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type BITUMRatesClient interface {
	SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (BITUMRates_SubscribeExchangesClient, error)
}
...
func NewBITUMRatesClient(cc *grpc.ClientConn) BITUMRatesClient {
	return &dCRRatesClient{cc}
}

func (c *dCRRatesClient) SubscribeExchanges(ctx context.Context, in *ExchangeSubscription, opts ...grpc.CallOption) (BITUMRates_SubscribeExchangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BITUMRates_serviceDesc.Streams[0], "/bitumrates.BITUMRates/SubscribeExchanges", opts...)
	if err != nil {
		return nil, err
	}
...
type BITUMRates_SubscribeExchangesClient interface {
...
// BITUMRatesServer is the server API for BITUMRates service.
type BITUMRatesServer interface {
	SubscribeExchanges(*ExchangeSubscription, BITUMRates_SubscribeExchangesServer) error
}

func RegisterBITUMRatesServer(s *grpc.Server, srv BITUMRatesServer) {
	s.RegisterService(&_BITUMRates_serviceDesc, srv)
}

func _BITUMRates_SubscribeExchanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExchangeSubscription)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BITUMRatesServer).SubscribeExchanges(m, &dCRRatesSubscribeExchangesServer{stream})
}

type BITUMRates_SubscribeExchangesServer interface {
...
var _BITUMRates_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bitumrates.BITUMRates",
	HandlerType: (*BITUMRatesServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SubscribeExchanges",
			Handler:       _BITUMRates_SubscribeExchanges_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "bitumrates.proto",
}

func init() { proto.RegisterFile("bitumrates.proto", fileDescriptor_bitumrates_9bf93ce756f00f36) }

var fileDescriptor_bitumrates_9bf93ce756f00f36 = []byte{
