...
var (
	...
	//rebuilddbHomeDir            = bitumutil.AppDataDir("rebuilddb", false)
	...
	defaultDBUser      = "bitumdata"
	defaultDBPass      = "bananas"
	defaultDBTableName = "bitumdata"
...
type config struct {
	...
	// RPC client options
	BitumdUser         string `long:"bitumduser" description:"Daemon RPC user name"`
	BitumdPass         string `long:"bitumdpass" description:"Daemon RPC password"`
	BitumdServ         string `long:"bitumdserv" description:"Hostname/IP and port of bitumd RPC server to connect to (default localhost:9209, testnet: localhost:19209, simnet: localhost:19556)"`
	BitumdCert         string `long:"bitumdcert" description:"File containing the bitumd certificate file"`
...
func cleanAndExpandPath(path string) string {
	...
	if strings.HasPrefix(path, "~") {
		homeDir := filepath.Dir(bitumdHomeDir)
...
func loadConfig() (*config, error) {
	...
	if cfg.BitumdServ == "" {
		cfg.BitumdServ = defaultHost + ":" + activeNet.JSONRPCClientPort
	}
...
// const (
//     defaultDBTableName = "bitumdata"
//     defaultDBUserName = "bitumdata"
//     defaultDBPass = "bitumpassword"
//     defaultDBFileName = "bitumdata.sqlt.dat"
//     defaultDBHostPort = "127.0.0.1:3660"
// )

// type configuration struct {
//     DaemonHostPort string `json:"bitumdhost"`
//     DaemonUser string `json:"bitumduser"`
//     DaemonPass string `json:"bitumdpass"`
