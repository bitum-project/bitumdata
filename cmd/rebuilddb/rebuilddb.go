...
func init() {
	...
	bitumsqlite.UseLogger(rpcclientLogger)
...
func mainCore() int {
	...
	client, _, err := rpcutils.ConnectNodeRPC(cfg.BitumdServ, cfg.BitumdUser,
		cfg.BitumdPass, cfg.BitumdCert, cfg.DisableDaemonTLS, false)
	if err != nil {
