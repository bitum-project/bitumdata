...
// GetRawTransaction gets a bitumjson.TxRawResult for the specified transaction
// hash.
...
func (pgb *ChainDBRPC) InsightSearchRPCAddressTransactions(addr string, count,
	skip int) []*bitumjson.SearchRawTransactionsResult {
...
// GetBlockVerboseByHash returns a *bitumjson.GetBlockVerboseResult for the
