...
const (
	...
	TableNameSummaries = "bitumdata_block_summary"
	// TableNameStakeInfo is name of the table used to store extended stake info
	TableNameStakeInfo = "bitumdata_stakeinfo_extended"
...
type DB struct {
	*sql.DB
	...
	// Drop shutdownBitumdata when the "database is locked" error is mitigated.
	// See https://github.com/bitum-project/bitumdata/issues/1133 for more info.
	shutdownBitumdata func()
...
// until resolved. See https://github.com/bitum-project/bitumdata/issues/1133 for info.
...
func (db *DB) JustifyTableStructures(dbInfo *DBInfo) error {
	...
	bkpPath := filepath.Join(directory, "bitumdata.nosidechains-bkp.db")
