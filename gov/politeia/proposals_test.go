...
import (
	...
	piapi "github.com/bitum-project/politeia/politeiawww/api/www/v1"
)
...
func TestNewProposalsDB(t *testing.T) {
	var count int
	inputURLPath := "https://proposals.bitum.io"
	expectedPath := "https://proposals.bitum.io/api/v1"
...
func TestGenerateCustomID(t *testing.T) {
	...
	td := []testData{
		...
		{
			title:    "Bitum Bug Bounty Proposal",
			customID: "bitum-bug-bounty-proposal",
		},
		{
		...
		{
			title:    "Proposed Statement Of Work (SOW) For Bitum Blockchain Wallet Tutorial Campaign",
			customID: "proposed-statement-of-work-sow-for-bitum-blockchain-wallet-tutorial-campaign",
		},
	}
