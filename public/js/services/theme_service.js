...
var darkBGCookieName = 'bitumdataDarkBG'
...
function toggleToDarkClasses (body) {
  sunIcon.classList.remove('bitumicon-sun-fill')
  sunIcon.classList.add('bitumicon-sun-stroke')
  body.classList.add('darkBG')
}
function toggleToLightClasses (body) {
  body.classList.remove('darkBG')
  sunIcon.classList.remove('bitumicon-sun-stroke')
  sunIcon.classList.add('bitumicon-sun-fill')
}
